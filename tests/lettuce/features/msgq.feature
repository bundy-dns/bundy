Feature: Message queue tests
    ...
    Scenario: logging
        ...
        And wait for bundy log message MSGQ_START
        And wait for bundy log message MSGQ_LISTENER_STARTED
        And wait for bundy log message MSGQ_CFGMGR_SUBSCRIBED
        ...
        And wait for bundy log message MSGQ_CONFIG_DATA
