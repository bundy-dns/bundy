Feature: Xfrin
    Tests for Xfrin, specific for BUNDY behaviour.
    ...
    When I set bundy configuration Xfrin/zones to [{"master_port": 56176, "name": "example.org", "master_addr": "::1"}]
    ...
    # We transfer from one bundy to other, just like in the Retransfer command
